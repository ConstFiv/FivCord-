...
ajax('POST', "http://127.0.0.1:3000/", 'name='+all); //传单个值的方法
    ...
    //回车发送后清空输入框
      chatPlaceInput.value = "";
        ...
        //  //###############################重新读取
        //  var li = document.createElement("li");
        //  var index = jsonData.data.length-1;
        //  li.innerHTML = "<div class='pic' style='background-color: "+jsonData.data[index].bgcolorOfImg+";''><span class= 'iconfont "+jsonData.data[index].imgs+" ' style='font-size: "+jsonData.data[index].fontSize+";'></span></div>\
        //  <div class='dataElse'>\
        //  <div class='dataElseUp'>\
        //  <div class='name'>"+jsonData.data[index].yourname+"</div>\
        //  <div class='time'>"+jsonData.data[index].timeNow+"</div></div>\
        //  <div class='word'>"+jsonData.data[index].sayWord+"</div></div>"
