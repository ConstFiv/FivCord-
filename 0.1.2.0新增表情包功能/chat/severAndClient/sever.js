...
function reWriteToJs(){
    ...
    fs.readFile('C:/Users/Dell/Desktop/HB文件/废物聊天室1.0/开发中/chat/chatHistoryData/chatData.json',function(err,data){
        var msg = data.toString();          //将二进制的数据转换为字符串
        // msg = JSON.parse(msg);              //将字符串转换为json对象
        
        fs.writeFileSync('C:/Users/Dell/Desktop/HB文件/废物聊天室1.0/开发中/chat/chatHistoryData/chatData.js', "jsonData = "+msg);
...
function addData(params){
    ...
    fs.readFile('C:/Users/Dell/Desktop/HB文件/废物聊天室1.0/开发中/chat/chatHistoryData/chatData.json',function(err,data){
        ...
        fs.writeFile('../chatHistoryData/chatData.json',str,function(err){
            if(err){
                console.error(err);
            }
            console.log('----------新增成功-------------');
